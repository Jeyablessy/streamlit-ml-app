...
SENDER_PASSWORD = "ncofrhvwnhscromx" 
# Use app password 
...
if new_supplier: 
body += "Our predictive monitoring system has detected a HIGH defect risk for a new supplier 
batch.\n\n" 
else: 
body += "Our predictive monitoring system has detected HIGH defect risk for the following 
suppliers:\n\n" 
for name, score in zip(supplier_names, risk_scores): 
body += f"Supplier: {name}\nPredicted Status: HIGH DEFECT RISK\nPredicted Risk Score: 
{score:.2f}\n\n" 
...
msg['To'] = RECEIVER_EMAILmsg['Subject'] = subject 
...
# Load Dataset 
data_path = r"C:\Users\Dell\Downloads\supplier_defect_dataset.csv" # Replace with your CSV path 
...
# Top Risky Suppliers 
9ranking = data[["Supplier_ID", "Risk_Score"]].sort_values(by="Risk_Score", ascending=False) 
print("\nTop 10 Risky Suppliers:") 
display(ranking.head(10)) 
# Alert for High-Risk Suppliers in Dataset 
RISK_THRESHOLD = 0.7 
...
display(high_risk_suppliers[["Supplier_ID", "Risk_Score"]]) 
send_email_alert( 
...
# Predict a New Supplier Batch 
new_supplier = pd.DataFrame([[900, 6, 4.8]], columns=["Order_Quantity", "Delivery_Delay", 
